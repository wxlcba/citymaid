...
if ( ! function_exists( 'business_era_get_slider_details' ) ) :
...
if ( ! function_exists( 'business_era_get_the_excerpt' ) ) :
	 ...
	 */
	function business_era_get_the_excerpt( $length = 0, $post_object = null ) {
		global $post;
...
if ( ! function_exists( 'business_era_fonts_url' ) ) :
	 ...
	 */
	function business_era_fonts_url() {
		$fonts_url = '';
		$fonts     = array();
		$subsets   = 'latin,latin-ext';

		/* translators: If there are characters in your language that are not supported by Open Sans, translate this to 'off'. Do not translate into your own language. */
		if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'business-era' ) ) {
			$fonts[] = 'Open Sans:400,700,900,400italic,700italic,900italic';
		}
		/* translators: If there are characters in your language that are not supported by Open Sans, translate this to 'off'. Do not translate into your own language. */
		if ( 'off' !== _x( 'on', 'Raleway font: on or off', 'business-era' ) ) {
